...
class Ghostie extends React.Component {
    render() {
        return (
            <div className="container">
              <svg className="ghost" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                 ...
                 xmlSpace="preserve">
              <path fill="#f4f6f6" d="M116.223,125.064c1.032-1.183,1.323-2.73,1.391-3.747V54.76c0,0-4.625-34.875-36.125-44.375
              ...
              <path fill="#013E51" d="M71.916,62.782c0.05-1.108-0.809-2.046-1.917-2.095c-0.673-0.03-1.28,0.279-1.667,0.771
                ...
                <p className="shadowFrame"><svg version="1.1" className="shadow" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="61px" y="20px"
                 ...
                 xmlSpace="preserve">
              <ellipse fill="#b689b0" cx="61.128" cy="19.872" rx="49.25" ry="8.916"/>
                  </svg></p>
            </div>
        )
    }
